    ...
    <div className="flex w-full items-center flex-col gap-20">
      ...
      <section className="flex flex-col gap-5 mb-10">
        ...
        <article className="flex justify-between">
          <p
            onClick={openExplore}
            className="text-2xxl font-semibold text-prim-1 rounded-xl py-3 px-10 hover:cursor-pointer hover:scale-105 duration-200 transition ease-in-out bg-orange-600"
          >
            Explore
          </p>
          <p
